...
x.t("policyperiod.policynumber","policy");
x.t("remove","database");
x.t("features","sql");
x.t("mirror","single");
x.t("sure","find");
...
x.t("desired","words");
x.t("(policy.policynumber)","retrieving");
...
x.t("addascendingsortcolumn","policyperiod.policynumber");
x.t("catch","(e)");
x.t("across","count");
x.t("across","find");
