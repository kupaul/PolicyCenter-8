...
else if (Guidewire_TopicMatch(TOPIC,"Running a Single-user Instance of Product Designer") && Guidewire_FMSourceFileMatch(SRCFILE,"install.4.2.html") ) { return "install.4.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Installing a Multi-user Instance of Product Designer") && Guidewire_FMSourceFileMatch(SRCFILE,"install.4.3.html") ) { return "install.4.3.html";}
