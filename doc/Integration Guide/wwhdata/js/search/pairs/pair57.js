...
x.t("policytype.tc_wc.tostring","return");
x.t("publishing","web");
x.t("possible","values");
...
x.t("numeric","value");
x.t("numbers","gosu");
x.t("policytype.gettc_wc","convert");
x.t("call","policytype.tc_wc.tostring");
...
x.t("names","example");
x.t("names","typelist");
x.t("policytype.tc_wc","worker\u2019s");
x.t("policytype.tc_wc","policytype.gettc_wc");
